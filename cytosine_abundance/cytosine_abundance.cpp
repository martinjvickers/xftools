...
{
   ArgumentParser parser("cytosine_abundance");
   ...
   addDescription(parser, "The purpose of this program is to calculate the \
                           cytosine abundance and cytosine context's in a  \
                           reference genome.");
   ...
   addOption(parser, ArgParseOption("l", "label", "Column 3 GFF output label.\
                                    Useful if using SignalMap as GFFs with the\
                                    same label will be merged.", 
   ...
   addOption(parser, ArgParseOption("p", "percentage", "Rather than \
                                    calculating the number of C's, calculate\
                                     the percentage of C's in the window."));

   addOption(parser, ArgParseOption("r", "input-region-file", 
                                    "Path to the input file contains regions \
                                    you're interested in calculating stats for.",
                                    ArgParseArgument::INPUT_FILE, "IN"));
